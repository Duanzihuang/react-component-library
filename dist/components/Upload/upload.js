...
export var Upload = function (props) {
    ...
    return (_jsxs("div", __assign({ className: 'viking-upload-component' }, { children: [_jsx(Button, __assign({ btnType: 'primary', onClick: handleClick }, { children: drag ? (_jsx(Dragger, __assign({ onFile: function (files) { return uploadFiles(files); } }, { children: children }))) : (children) })), _jsx("input", { type: 'file', className: 'viking-file-input', style: { display: 'none' }, ref: fileInput, onChange: handleFileChange, accept: accept, multiple: multiple }), _jsx(UploadList, { fileList: fileList, onRemove: handleRemove })] })));
};
Upload.defaultProps = {
    name: 'image'
};
